...
export default function AdminStripePage() {
    ...
    const [appSlug, setAppSlug] = useState('skill-tango')
                    ...
                    <div style={{
                        ...
                        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            <div className="login-form__field" style={{ marginBottom: ('24px' as any) }}>
                                ...
                                <Textarea rows={5} value={features} onChange={(e: any) => setFeatures(e.target.value)} placeholder="Feature 1&#10;Feature 2&#10;Feature 3" required />
                            </div>
